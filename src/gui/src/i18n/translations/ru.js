...
const ru = {
  ...
  dictionary: {
    ...
    "choose_publishing_option": 'Выберите, как вы хотите опубликовать свой веб-сайт:', // In English: "Choose how you want to publish your website:"
    "create_desktop_shortcut": 'Создать ярлык (Рабочий стол)', // In English: "Create Shortcut (Desktop)"
    "create_desktop_shortcut_s": 'Создать ярлыки (Рабочий стол)', // In English: "Create Shortcuts (Desktop)"
    ...
    "pick_name_for_worker": 'Выберите имя для вашего воркер', // In English: "Pick a name for your worker:"
    "publish_as_serverless_worker": 'Опубликовать как воркер', // In English: "Publish as Worker"
    ...
    "toolbar.refer": 'Сослаться', // In English: "Refer"
    ...
    "used_of": 'используется для', // In English: "{{used}} used of {{available}}"
    "worker": 'воркер', // In English: "Worker"
    "billing.offering.basic": 'Основной', // In English: "Basic"
    "too_many_attempts": 'Слишком много попыток. Пожалуйста, попробуйте позже.', // In English: "Too many attempts. Please try again later."
    "server_timeout": 'Сервер слишком долго не отвечал. Пожалуйста, попробуйте снова.', // In English: "The server took too long to respond. Please try again."
    "signup_error": 'Произошла ошибка при регистрации. Пожалуйста, попробуйте снова.', // In English: "An error occurred during signup. Please try again."
    ...
    "welcome_get_started": 'Приступить', // In English: "Get Started"
    ...
    "window_title_refer_friend": 'Ссылаться другa', // In English: "Refer a friend!"
